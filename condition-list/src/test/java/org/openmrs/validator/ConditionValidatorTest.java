...
public class ConditionValidatorTest extends BaseModuleContextSensitiveTest {
    ...
    public void shouldNotAllowNonCodedConceptConditionWithoutNonCodedConditionValue() {
        ...
        Assert.assertTrue(errors.hasErrors());
        Assert.assertEquals("Condition.error.conditionNonCodedValueNeededForNonCodedCondition", ((List<ObjectError>) errors.getAllErrors()).get(0).getCode());
    }
    ...
    public void shouldNotAllowNonCodedValueForCodedConceptCondition() {
        ...
        conditionValidator.validate(condition, errors);
        Assert.assertTrue(errors.hasErrors());
        Assert.assertEquals("Condition.error.conditionNonCodedValueNotSupportedForCodedCondition", ((List<ObjectError>) errors.getAllErrors()).get(0).getCode());
    }

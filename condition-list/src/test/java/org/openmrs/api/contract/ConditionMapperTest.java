package org.openmrs.api.contract;
...
public class ConditionMapperTest {
	...
	public void shouldMapContractConditionToOpenmrsCondition() throws Exception {
		...
		Concept endReason = new Concept();
		endReason.setUuid(endReasonUuid);
		condition.setEndReason(new org.openmrs.api.contract.Concept(endReasonUuid, "somename"));
		condition.setEndDate(today);
		
		concept.setUuid(conceptUuid);
		Patient patient = new Patient();
		patient.setUuid(patientUuid);
		condition.setConcept(new org.openmrs.api.contract.Concept(conceptUuid, "somename"));
